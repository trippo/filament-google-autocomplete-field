...
class GoogleAutocomplete extends Component
{
    ...
    protected array|int|string|Closure $autocompleteFieldColumnSpan = 'full';
    ...
    public function autocompleteFieldColumnSpan(array|int|string|Closure $autocompleteFieldColumnSpan = 'full'): static
    {
    ...
    public function getAutocompleteFieldColumnSpan(): string|array|int|null
    {
